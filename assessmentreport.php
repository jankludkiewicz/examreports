...
$grades = $DB->get_records_sql("SELECT student.id AS userid, student.firstname AS studentfirstname, student.lastname AS studentlastname, grades.feedback AS feedback, items.gradepass, grades.finalgrade AS finalgrade, grader.firstname AS graderfirstname, grader.lastname AS graderlastname, grades.timemodified AS timegraded, categories.id AS categoryid 
