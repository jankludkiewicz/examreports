...
foreach ($grades as $grade) {
	...
	if ($first->categoryid==SUMMATIVE_ASSESSMENT_CATEGORY) {
		...
		$html .= '<tr><td style="width: 50%; background-color: #86baf2; text-align: center; font-weight: bold;">Wynik oceny:</td><td style="width: 50%; text-align: center;">PASS:'.$pass.' '.($pass?'ZALICZONY / <s>NIEZALICZONY</s>':'<s>ZALICZONY</s> / NIEZALICZONY').'*</td></tr>';
		$html .= '</table>';
	}
