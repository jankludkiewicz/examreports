...
class grade_export_form extends moodleform {
    function definition() {
        ...
        */
		...
		if (!empty($features['selectreporttype'])) {
			$radio = array();
			$radio[] = $mform->createElement('radio', 'reporttype', null, 'Progress Exam', 'progress');
			$radio[] = $mform->createElement('radio', 'reporttype', null, 'Final Exam', 'final');
			$mform->addGroup($radio, 'reporttype', 'Report type', '', false);
			$mform->setDefault('reporttype', 'progress');
		}
